...
class db_Search_Public {
	...
	public function enqueue_styles() {
		...
		wp_enqueue_style( $this->db_search, plugin_dir_url( __FILE__ ) . 'css/db-search-public.css', array(), $this->version, 'all' );
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( $this->db_search, plugin_dir_url( __FILE__ ) . 'js/db-search-public.js', array( 'jquery', 'jquery-migrate' ), $this->version, false );
